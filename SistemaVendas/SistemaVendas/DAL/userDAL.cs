...
namespace SistemaVendas.DAL
{
    class userDAL
    {
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                String sql = "INSERT INTO tbl_usuarios(nome,s_nome,email,usuario,senha,contato,endereco,usuario_tipo,add_data,add_por) VALUES (@nome,@s_nome,@email,@usuario,@senha,@contato,@endereco,@usuario_tipo,@add_data,@add_por)";
                SqlCommand cmd = new SqlCommand(sql, conn);
        ...
        public bool Update(userBLL u)
        {
            ...
            try
            {
                String sql = "UPDATE tbl_usuarios SET nome=@nome,s_nome=@s_nome,email=@email,usuario=@usuario,senha=@senha,contato=@contato,endereco=@endereco,usuario_tipo=@usuario_tipo,add_data=@add_data,add_por=@add_por WHERE id=@id";
                SqlCommand cmd = new SqlCommand(sql, conn);
